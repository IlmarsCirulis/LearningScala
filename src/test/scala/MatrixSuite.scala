...
class MatrixSuite extends AnyFunSuite {
  ...
  test("Test another constructor, that accepts function and dimensions") {
    val firstRow = Fraction(1) :: Fraction(0) :: Fraction(0) :: Nil
    val secondRow = Fraction(1) :: Fraction(1) :: Fraction(0) :: Nil
    val thirdRow = Fraction(1) :: Fraction(1) :: Fraction(1) :: Nil
    val firstMatrix = Matrix(firstRow :: secondRow :: thirdRow :: Nil)
    val fun = (row: Int) => (col: Int) => if (col <= row) Fraction(1) else Fraction(0)
  ...
  test("Test constructor that takes size and makes unit matrix of that size") {
    val firstRow = Fraction(1) :: Fraction(0) :: Fraction(0) :: Nil
    val secondRow = Fraction(0) :: Fraction(1) :: Fraction(0) :: Nil
    val thirdRow = Fraction(0) :: Fraction(0) :: Fraction(1) :: Nil
    val firstMatrix = Matrix(firstRow :: secondRow :: thirdRow :: Nil)
    val secondMatrix = Matrix(3)
    assert(firstMatrix == secondMatrix)
  }

  /* Testing method "isSquareMatrix" */
  ...
  test("Given square matrix, isSquareMatrix returns true") {
    ...
    val thirdRow = Fraction(3) :: Fraction(4) :: Fraction(3, 10) :: Nil
  ...
  test("Transposition of square matrix") {
    val firstRow = Fraction(1) :: Fraction(5, 4) :: Fraction(7, 2) :: Nil
    val secondRow = Fraction(5, 4) :: Fraction(9, 5) :: Fraction(1, 5) :: Nil
    val thirdRow = Fraction(1, 2) :: Fraction(9, 8) :: Fraction(3) :: Nil
    val firstMatrix = Matrix(firstRow :: secondRow :: thirdRow :: Nil)
    val firstColumn = Fraction(1) :: Fraction(5, 4) :: Fraction(1, 2) :: Nil
    val secondColumn = Fraction(5, 4) :: Fraction(9, 5) :: Fraction(9, 8) :: Nil
    val thirdColumn = Fraction(7, 2) :: Fraction(1, 5) :: Fraction(3) :: Nil
  ...
  test("Transposition of non-square matrix") {
    ...
    val firstColumn = Fraction(1) :: Nil
  ...
  test("Sum of two 2x2 matrices") {
    val firstMatrix = Matrix((Fraction(1) :: Fraction(-5, 2) :: Nil) :: (Fraction(7, 8) :: Fraction(1, 5) :: Nil) :: Nil)
    val secondMatrix = Matrix((Fraction(5, 7) :: Fraction(1, 2) :: Nil) :: (Fraction(2, 7) :: Fraction(-3) :: Nil) :: Nil)
    val sumMatrix = Matrix((Fraction(12, 7) :: Fraction(-2) :: Nil) :: (Fraction(65, 56) :: Fraction(-14, 5) :: Nil) :: Nil)
    assert (firstMatrix.add(secondMatrix) == sumMatrix)
  }

  test("Matrices with different dimensions can't be summed") {
    val firstMatrix = Matrix((Fraction(1, 4) :: Fraction(1, 8) :: Nil) :: (Fraction(-6, 7) :: Fraction(2) :: Nil) :: Nil)
  ...
  test("Difference of two 2x2 matrices") {
    ...
    val secondMatrix = Matrix((Fraction(-1) :: Fraction(9, 10) :: Nil) :: (Fraction(2) :: Fraction(1, 2) :: Nil) :: Nil)
  ...
  test("Matrices with different dimensions can't be subtracted") {
    ...
    val secondMatrix = Matrix((Fraction(-4, 9) :: Nil) :: (Fraction(-2) :: Nil) :: Nil)
  ...
  test("Multiply matrices of dimensions 1x2 and 2x3") {
    val firstMatrix = Matrix((Fraction(1) :: Fraction(5) :: Nil) :: Nil)
    val secondMatrix = Matrix((Fraction(-1, 2) :: Fraction(-1, 2) :: Fraction(-1) :: Nil) :: (Fraction(-7, 3) :: Fraction(2, 3) :: Fraction(-10, 9) :: Nil) :: Nil)
  ...
  test("Multiply matrices of dimensions 1x2 and 2x1") {
    ...
    val expectedResult = Matrix((Fraction(-2) :: Nil) :: Nil)
  }
  ...
  test("Gaussian elimination first part of invertible matrix, checking only resulting matrix") {
    ...
    val thirdRow = Fraction(-3) :: Fraction(-1) :: Fraction(-1, 6) :: Nil
    val matrix = Matrix(firstRow :: secondRow :: thirdRow :: Nil)
    val firstRowOfResult = Fraction(1) :: Fraction(-5, 3) :: Fraction(10, 9) :: Nil
    val secondRowOfResult = Fraction(0) :: Fraction(1) :: Fraction(155, 51) :: Nil
    val thirdRowOfResult = Fraction(0) :: Fraction(0) :: Fraction(1) :: Nil
  ...
  test("Gaussian elimination first part of non-invertible matrix, checking only resulting matrix") {
    val firstRow = Fraction(-1, 2) :: Fraction(-8, 7) :: Fraction(-5) :: Nil
    val secondRow = Fraction(1) :: Fraction(-8, 3) :: Fraction(0) :: Nil
    val thirdRow = Fraction(1) :: Fraction(0) :: Fraction(70, 13) :: Nil
    val matrix = Matrix(firstRow :: secondRow :: thirdRow :: Nil)
    val firstRowOfResult = Fraction(1) :: Fraction(16, 7) :: Fraction(10) :: Nil
    val secondRowOfResult = Fraction(0) :: Fraction(1) :: Fraction(105, 52) :: Nil
    val thirdRowOfResult = Fraction(0) :: Fraction(0) :: Fraction(0) :: Nil
    val result = Matrix(firstRowOfResult :: secondRowOfResult :: thirdRowOfResult :: Nil)
    matrix.gaussianEliminationPartOne()
    assert(matrix == result)
  }
  ...
  test("Gaussian elimination, both parts, on invertible matrix, checking only resulting matrix") {
    val firstRow = Fraction(5) :: Fraction(-1, 2) :: Fraction(7, 3) :: Nil
    val secondRow = Fraction(-10) :: Fraction(-8, 5) :: Fraction(-6, 5) :: Nil
  ...
  test("Gaussian elimination, both parts, on non-invertible matrix, checking only resulting matrix") {
    val firstRow = Fraction(-1) :: Fraction(-5, 3) :: Fraction(2) :: Nil
    val secondRow = Fraction(7, 2) :: Fraction(-1) :: Fraction(-1, 2) :: Nil
    val thirdRow = Fraction(-1, 2) :: Fraction(-9, 10) :: Fraction(218, 205) :: Nil
    val matrix = Matrix(firstRow :: secondRow :: thirdRow :: Nil)
    val firstRowOfResult = Fraction(1) :: Fraction(0) :: Fraction(-17, 41) :: Nil
    val secondRowOfResult = Fraction(0) :: Fraction(1) :: Fraction(-39, 41) :: Nil
    val thirdRowOfResult = Fraction(0) :: Fraction(0) :: Fraction(0) :: Nil
    val result = Matrix(firstRowOfResult :: secondRowOfResult :: thirdRowOfResult :: Nil)
    matrix.gaussianEliminationBothParts()
    assert(matrix == result)
  ...
  test("Gaussian elimination, both parts, on 4x4 matrix with rank = 2") {
    val firstRow = Fraction(2) :: Fraction(3) :: Fraction(4) :: Fraction(5) :: Nil
    val secondRow = Fraction(3) :: Fraction(4) :: Fraction(5) :: Fraction(6) :: Nil
    val thirdRow = Fraction(4) :: Fraction(5) :: Fraction(6) :: Fraction(7) :: Nil
    val fourthRow = Fraction(9) :: Fraction(10) :: Fraction(11) :: Fraction(12) :: Nil
    val matrix = Matrix(firstRow :: secondRow :: thirdRow :: fourthRow :: Nil)
    matrix.gaussianEliminationBothParts()
    val firstRowOfResult = Fraction(1) :: Fraction(0) :: Fraction(-1) :: Fraction(-2) :: Nil
    val secondRowOfResult = Fraction(0) :: Fraction(1) :: Fraction(2) :: Fraction(3) :: Nil
    val thirdRowOfResult = Fraction(0) :: Fraction(0) :: Fraction(0) :: Fraction(0) :: Nil
